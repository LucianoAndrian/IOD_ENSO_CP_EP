"""
Control de la seleccion de eventos observados: graficos 3D
"""
# ---------------------------------------------------------------------------- #
save = False
run = False
out_dir_tk = '/home/luciano.andrian/doc/IOD_ENSO_CP_EP/salidas/frames3d_obs_tk/'
out_dir_td = '/home/luciano.andrian/doc/IOD_ENSO_CP_EP/salidas/frames3d_obs_td/'
out_dir_n = '/home/luciano.andrian/doc/IOD_ENSO_CP_EP/salidas/frames3d_obs_n/'
...
if run:
    ...
    y = ep_tk
    z = cp_tk
    generate_rotation_sequence(x, y, z, out_dir=out_dir_tk,
    ...
    y = ep_td
    z = cp_td
    generate_rotation_sequence(x, y, z, out_dir=out_dir_td,
                               steps_per_transition=45,
                               save=save)
    ...
    y = ep_n
    z = cp_n
    generate_rotation_sequence(x, y, z, out_dir=out_dir_n,
                               steps_per_transition=45,
                               save=save)
