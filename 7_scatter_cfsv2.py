...
def tmp_PlotScatter(idx1_name, idx2_name, idx1_sd, idx2_sd, save=save,
...
def tmp_PlotScatter_simple(idx1, idx2, idx1_name, idx2_name, save=save,
                           out_dir=out_dir,  name_fig='fig'):
    if save:
        dpi = 300
    else:
...
# ---------------------------------------------------------------------------- #
# Indice vs Indice en el modelo
index_dir_tk = '/pikachu/datos/luciano.andrian/DMI_N34_Leads_r/tk/'
index_dir_td = '/pikachu/datos/luciano.andrian/DMI_N34_Leads_r/td/'
index_dir_n = '/pikachu/datos/luciano.andrian/DMI_N34_Leads_r/n/'

# CP:
cp = OpenAndSet(index_dir_tk, 'CP_SON_Leads_r_CFSv2.nc')
cp_td = OpenAndSet(index_dir_td, 'CP_Td_SON_Leads_r_CFSv2.nc')
cp_n = OpenAndSet(index_dir_n, 'CP_n_SON_Leads_r_CFSv2.nc')

tmp_PlotScatter_simple(idx1=cp, idx2=cp_td, idx1_name='CP', idx2_name='CP_Td',
                       save=save, out_dir=out_dir,  name_fig='CP_vs_CP_td')

tmp_PlotScatter_simple(idx1=cp, idx2=cp_n, idx1_name='CP', idx2_name='CP_n',
                       save=save, out_dir=out_dir,  name_fig='CP_vs_CP_n')

tmp_PlotScatter_simple(idx1=cp_td, idx2=cp_n, idx1_name='CP_td', idx2_name='CP_n',
                       save=save, out_dir=out_dir,  name_fig='CP_n_vs_CP_td')

# EP:
ep = OpenAndSet(index_dir_tk, 'EP_SON_Leads_r_CFSv2.nc')
ep_td = OpenAndSet(index_dir_td, 'EP_Td_SON_Leads_r_CFSv2.nc')
ep_n = OpenAndSet(index_dir_n, 'EP_n_SON_Leads_r_CFSv2.nc')

tmp_PlotScatter_simple(idx1=ep, idx2=ep_td, idx1_name='EP', idx2_name='EP_Td',
                       save=save, out_dir=out_dir,  name_fig='EP_vs_EP_td')

tmp_PlotScatter_simple(idx1=ep, idx2=ep_n, idx1_name='EP', idx2_name='EP_n',
                       save=save, out_dir=out_dir,  name_fig='EP_vs_EP_n')

tmp_PlotScatter_simple(idx1=ep_td, idx2=ep_n, idx1_name='EP_td', idx2_name='EP_n',
                       save=save, out_dir=out_dir,  name_fig='EP_n_vs_EP_td')
