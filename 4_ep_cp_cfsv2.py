...
out_dir_tk = '/pikachu/datos/luciano.andrian/DMI_N34_Leads_r/tk/'
out_dir_td = '/pikachu/datos/luciano.andrian/DMI_N34_Leads_r/td/'
out_dir_n = '/pikachu/datos/luciano.andrian/DMI_N34_Leads_r/n/'
...
PlotScatter(idx1=pc1_ch, idx2=pc2_ch, idx1_name='PC1', idx2_name='PC2',
            save=save_plots, out_dir=our_dir_plots,
...
if save:
    print('Saving...')
    cp.to_netcdf(f'{out_dir_tk}CP_SON_Leads_r_CFSv2.nc')
    ep.to_netcdf(f'{out_dir_tk}EP_SON_Leads_r_CFSv2.nc')

    cp_td.to_netcdf(f'{out_dir_td}CP_Td_SON_Leads_r_CFSv2.nc')
    ep_td.to_netcdf(f'{out_dir_td}EP_Td_SON_Leads_r_CFSv2.nc')

    cp_n.to_netcdf(f'{out_dir_n}CP_n_SON_Leads_r_CFSv2.nc')
    ep_n.to_netcdf(f'{out_dir_n}EP_n_SON_Leads_r_CFSv2.nc')
