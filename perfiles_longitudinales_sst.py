...
from Funciones import DMI, open_and_load, DarkenColor
...
cfsv2_cases_fields_n = '/pikachu/datos/luciano.andrian/cases_fields_EP_CP/aux_ep_cp_n/'
cfsv2_cases_fields_t = '/pikachu/datos/luciano.andrian/cases_fields_EP_CP/aux_ep_cp_t/'
...
def PlotSST_lon(serie, color, title, name_fig, save,
...
for cp, ep, t in zip([cp_tk, cp_td, cp_n],
    ...
    for c, t2, fn, color in zip(cases_ordenados, titles, name_figs, colors):
        ...
        PlotSST_lon(case_events, color, title_fig, name_fig, save)
# ---------------------------------------------------------------------------- #
# ---------------------------------------------------------------------------- #

variables = ['sst']

dirs_cfsv2 = [cfsv2_cases_fields, cfsv2_cases_fields_t, cfsv2_cases_fields_n]
v = 'sst'
for t, dir in zip(['Tk', 'Td', 'n'], dirs_cfsv2):
