...
SaveNC(jja_hindcast, f'{out_dir}{v_name}_aux_hindcast_no_detrend_jja.nc')

logger.info('Saving: detrend...')
SaveNC(jja_hindcast_detrend, f'{out_dir}{v_name}_aux_hindcast_detrend_jja.nc')

logger.info('Saving: clim...')
SaveNC(jja_clim_99_11, f'{out_dir}{v_name}_aux_jja_clim_99_11.nc')
...
jja_clim_99_11 = xr.open_dataset(f'{out_dir}{v_name}_aux_jja_clim_99_11.nc')
jja_hindcast_no_detrend = \
    xr.open_dataset(f'{out_dir}{v_name}_aux_hindcast_no_detrend_jja.nc')
jja_hindcast_detrend = \
    xr.open_dataset(f'{out_dir}{v_name}_aux_hindcast_detrend_jja.nc')
...
if save_nc:
    ...
    logger.info('Saving: no detrend...')
    SaveNC(jja_f, f'{out_dir}{v_name}_jja_no_detrend.nc')

    logger.info('Saving: detrend...')
    SaveNC(jja_f_detrend, f'{out_dir}{v_name}_jja_detrend.nc')
